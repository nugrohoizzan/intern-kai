...
<nav>
        <div class="layar-dalam">
            <div class="logo">
                <a href="index.php"><img src="asset/KAI.png" class="biru" alt="Logo" /></a>
                <a href="index.php"><img src="asset/KAI_PUTIH.png" class="hitam" alt="Logo" /></a>
            </div>
    ...
    <div id="mySidebar" class="sidebar">
        ...
        <ul>
            ...
            <li><a href="lihat_asset_user.php"><i class="bi bi-eye-fill"></i> Lihat Data</a></li>
            <li><a href="profil_user.php" class="active"><i class="bi bi-person"></i> Profil User</a></li>
...
<div class="layar-penuh">
    ...
    <main> 
        ...
        <div class="wrapper" style="top: 50px;">
                    <form role="form" action="form_profil.php" method="post" class="form-tambah" enctype="multipart/form-data">
                        ...
                        <div class="input-box">
                            ...
                            <div class="input-field">
                                ...
                                <select name="kelamin" required>
                                    <option value="Laki-laki" <?php if($row['kelamin'] == 'Laki-laki') echo 'selected'; ?>>Laki-laki</option>
                                    <option value="Perempuan" <?php if($row['kelamin'] == 'Perempuan') echo 'selected'; ?>>Perempuan</option>
                                    <option value="Lainnya" <?php if($row['kelamin'] == 'Lainnya') echo 'selected'; ?>>Lainnya</option>
                                </select>
                            </div>
                        </div>
