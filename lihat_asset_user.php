        ...
        <div class="menu">
            <ul>
                ...
                <li>
                    ...
                    <ul class="dropdown">
                        <li><a href="lihat_asset_user.php">Lihat Data</a></li>
                    </ul>
                </li>
                <li>
                    <a href="#">Profil</a>
...
<div class="sidebar" id="sidebar">
    ...
    <ul>
        ...
        <li><a href="lihat_asset_user.php" class="active"><i class="bi bi-eye-fill"></i> Lihat Data</a></li>
        <li><a href="profil_user.php"><i class="bi bi-person"></i> Profil User</a></li>
...
<div class="search-container">
    ...
    <main>
        <div class="main-container">
            ...
            <div class="details-container" id="asset-details">
                ...
                <button id="whatsapp-button" class="icon-button1" title="Contact via WhatsApp"><i class="bi bi-whatsapp"></i></button>
            ...
            <div id="blok-detail-container">
                ...
                <div id="detail-foto" style="text-align: center;"></div><br>
                <table class="details-table">
                    <tr>
                        <th>ID Blok</th>
    ...
    fetch('get_assets.php')
        ...
        .then(data => {
            // Filter assets to only include those with status 'Belum Tersewa'
            const filteredAssets = data.filter(asset => asset.status.toLowerCase() === 'belum tersewa');
    ...
    Halo, Saya ingin menanyakan informasi lebih lanjut mengenai properti yang saya minati, berikut detailnya : 

    Alamat Properti: ${activeMarker.assetData.alamat}
    Nomor Aset: ${activeMarker.assetData.id}

    Mohon informasi mengenai ketersediaan dan detail lainnya terkait properti tersebut. 

    Terima kasih.Salam, `);
        const url = `https://wa.me/+6285184768183?text=${message}`;
