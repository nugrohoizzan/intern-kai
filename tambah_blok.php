...
<div class="layar-dalam">
    ...
    <div class="wrapper" style="top: 0px;">
        <form role="form" action="insert_blok.php" method="POST" class="form-tambah" enctype="multipart/form-data">
            <h3>Tambah Blok</h3>
            <div class="input-box">
                <div class="input-field">
                    <input type="text" name="id_blok" placeholder="ID Blok" required>
                    <i class="bi bi-person-vcard-fill"></i>
                </div>
                <div class="input-field">
                    <input type="text" name="asset_id" value="<?php echo $asset_id; ?>" disabled>
            ...
            <div class="input-box">
                <div class="input-field">
                    <input type="text" name="nama_blok" placeholder="Nama Blok" required>
            ...
            <div class="input-box">
                <div class="input-field">
                    ...
                    <input type="text" name="best_use" placeholder="Bagus digunakan untuk" required>
                </div>
                <div class="input-field">
            ...
            <div class="input-box">
                <div class="input-field">
                    <textarea name="deskripsi" rows="10" cols="20" placeholder="Deskripsi"></textarea>
                </div>
            </div>
            <div class="button-container">
            <button class="tambah" type="submit" name="submit" value="REGISTER">Tambah Blok</button>
            </div>
        </form>
    </div>
</div>
